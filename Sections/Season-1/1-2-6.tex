...
\SSpsetQ{
    Let triangle \(ABC\) have incentre \(I\) and circumcenter \(O\). Suppose that \( \angle AIO = 90^{\circ} \) and \( \angle CIO = 45^{\circ} \). Suppose the ratio \( AB : BC : CA \) can be expressed as \( a : b : c \) where \( \gcd(a, b, c) = 1 \). Find \( a + b + c \).
}\bigskip 
