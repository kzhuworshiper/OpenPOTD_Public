...
\SSpsetQ{
    If the polynomial \( x^2 + bx + 101 = 0 \) has integer roots \( m \) and \( n \), where \( \vert m \vert > \vert n \vert \), then what is the sum of the positive integer divisors of \( \frac mn \)?
}\bigskip 
